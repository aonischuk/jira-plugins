...
public abstract class BaseJiraSourceConfig extends ReferencePluginConfig {
  private static final String PROPERTY_JIRA_URL = "jiraUrl";
  private static final String PROPERTY_FILTER_MODE = "filterMode";
  private static final String PROPERTY_JIRA_FILTER_ID = "jiraFilterId";
  private static final String PROPERTY_JQL_QUERY = "jqlQuery";
  ...
  public void validate(FailureCollector failureCollector) {
    ...
    try {
      if (getFilterMode() == FilterMode.JIRA_FILTER_ID) {
        validatePropertySet(PROPERTY_JIRA_FILTER_ID, "Jira Filter Id", jiraFilterId, failureCollector);
      }
  ...
  public Integer getMaxIssuesPerRequest() {
    return (maxIssuesPerRequest == 0) ? Integer.MAX_VALUE : maxIssuesPerRequest;
  }
  ...
  public static void validatePropertySet(String propertyName, String propertyDisplayName,
